...
struct WebView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        webView.scrollView.bounces = isInteractive

        logWebView("[Swift] makeUIView: Loading HTML. Interactive: \(self.isInteractive)")
        webView.loadHTMLString(getFinalHTML(), baseURL: Bundle.main.resourceURL)
    ...
    func updateUIView(_ uiView: WKWebView, context: Context) {
        ...
        if context.coordinator.lastLoadedHTMLString != htmlString || oldIsInteractive != isInteractive {
            logWebView("[Swift] updateUIView: Reloading. Interactive: \(self.isInteractive)")
            uiView.loadHTMLString(getFinalHTML(), baseURL: Bundle.main.resourceURL)
            uiView.scrollView.isScrollEnabled = isInteractive
            uiView.scrollView.bounces = isInteractive
        }
    }
